...
import FairGuideStatus from "../../components/FairGuideStatus/FairGuideStatus.tsx";
...
const FairPage: React.FC = () => {
  ...
  }, [params.fairId, userContext, fair]);
  ...
  const refreshFair = () => {
    getFair(params.fairId as string).catch(console.error);
  };
                ...
                <Stack gap="0" className="bg-gray-50">
                  ...
                  <Divider className="border-gray-200" />
                  {
                    ...
                    <>
                      ...
                      <Divider className="border-gray-200" />
                      <FairGuideStatus fair={fair} refreshFair={refreshFair} />
                      <Divider className="border-gray-200" />
                    </>
                  }
