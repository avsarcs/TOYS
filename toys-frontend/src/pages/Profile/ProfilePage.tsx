...
import { ProfileRatingCard, ProfileReviewsList } from "../../components/ProfileReviews/ProfileReviews.tsx";
            ...
            <div className="profile-page">
                <Box className="content" p="xl" pt="">
                    ...
                    >
                        ...
                        {(profile.role === UserRole.GUIDE || profile.role === UserRole.ADVISOR) && (
                        <>
                            <Box p="xl">
                                <ProfileRatingCard guideId={profile.id} />
                            </Box>
                        </>
                    )}
                    ...
                    {(profile.role === UserRole.GUIDE || profile.role === UserRole.ADVISOR) && (
                        <>
                            ...
                            <Space h="xl" />
                            <Box p="xl">
                                <ProfileReviewsList guideId={profile.id} />
                            </Box>
                        </>
                    )}
                </Box>
