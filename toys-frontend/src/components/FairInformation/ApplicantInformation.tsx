    ...
    <Box p="lg">
      <Group>
        <Text size="md" fw={700}>Başvuran Bilgileri: &nbsp;
          <Text span>{ props.fair.applicant.fullname }</Text>
        </Text>
        <Popover trapFocus>
          <Popover.Target>
          ...
          <Popover.Dropdown p="lg" className="shadow-lg">
            <Text size="md" fw={700}>
              Email: &nbsp;<Text span>{ props.fair.applicant.email }</Text> &nbsp;
            ...
            <Text size="md" fw={700}>
              Telefon No: &nbsp;
              <Text span>
                { parsePhoneNumber(props.fair.applicant.phone, "TR").formatInternational() }
              </Text> &nbsp;
              <Button><Text span className="iconify text-lg solar--clipboard-list-linear"/></Button>
            </Text>
          </Popover.Dropdown>
