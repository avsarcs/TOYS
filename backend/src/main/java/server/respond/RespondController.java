...
public class RespondController {
    ...
    public void respondTourModification(@RequestParam String auth, @RequestParam String request_id, @RequestParam boolean response) {
        respondService.respondToTourModification(auth, request_id, response);
    }
    ...
    public void respondFairInvite(@RequestParam String auth, @RequestParam String request_id, @RequestParam boolean response) {
        respondService.respondToFairGuideInvite(auth, request_id, response);
    }

    @PostMapping("/respond/guide/tour-invite")
    public void respondTourInvite(@RequestParam String auth, @RequestParam String request_id, @RequestParam boolean response) {
        respondService.respondToTourGuideInvite(auth, request_id, response);
    }
